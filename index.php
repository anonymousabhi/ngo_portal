    ...
    <header class="masthead text-center text-white">
        <div class="masthead-content">
          <div class="container">
            ...
            <a href="modules/signup.php" class="btn btn-primary btn-xl rounded-pill mt-5">Sign Up</a>
          </div>
    </header>
    ...
    <section>
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="p-5">
                <img class="img-fluid rounded-circle" src="img/13.jpg" alt="">
              </div>
            </div>
            <div class="col-lg-6">
              <div class="p-5">
    ...
    <section>
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 order-lg-2">
              <div class="p-5">
                <img class="img-fluid rounded-circle" src="img/14.jpg" alt="">
              </div>
            </div>
            <div class="col-lg-6 order-lg-1">
              <div class="p-5">
    ...
    <section>
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 order-lg-2">
              <div class="p-5">
                <img class="img-fluid rounded-circle" src="img/15.jpg" alt="">
              </div>
            </div>
            <div class="col-lg-6 order-lg-1">
              <div class="p-5">
